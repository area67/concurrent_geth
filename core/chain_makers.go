...
func (b *BlockGen) AddTxWithChain(bc *BlockChain, tx *types.Transaction) {
	...
	b.statedb.Prepare(tx.Hash(), common.Hash{}, int32(len(b.txs)))
	receipt, _, err := ApplyTransaction(b.config, bc, &b.header.Coinbase, b.gasPool, b.statedb, b.header, tx, &b.header.GasUsed, vm.Config{}, 0)
	if err != nil {
		panic(err)
	}
